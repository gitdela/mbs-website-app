...
const Privacy = () => {
  return (
    <Container>
      <div className='text-white overflow-hidden pt-24'>
        <div className='w-full'>
          <div className='hidden md:block'>
            <Heading
              title='Privacy Policy'
              description='Last updated: March 13, 2023'
          ...
          <h1 className='text-3xl text-white uppercase mt-2'>
            Interpretation and Definitions
          </h1>
          <h2 className='font-medium text-2xl my-2 text-white'>
            1. Interpretation
          </h2>
          ...
          <ul className='list-disc text-sm my-2 pl-8 space-y-1'>
            <li>
            ...
            <li>
              <strong>Website&nbsp;</strong>refers to Mybitstore, accessible
              frommybitstore.com
            </li>
            <li>
          ...
          <h1 className='font-medium text-3xl text-white uppercase py-4 mt-6'>
            Collecting and Using Your Personal Data
          </h1>
          <h2 className='text-2xl mb-2 text-white'>Types of Data Collected</h2>
          <div className='text-sm'>
            <h2 className='text-xl my-4 text-white'>1. Personal Data</h2>
            <div>
              <p className='my-3'>
              ...
              <ul className='list-disc my-2 pl-8 space-y-1'>
                <li>Email address</li>
                <li>Username</li>
                <li>Password</li>
          ...
          <h2 className='text-xl my-4 text-white'>2. Usage Data</h2>
          <div className='text-sm'>
            <p className='my-3'>
          ...
          <h2 className='text-2xl my-4 pt-8 text-white'>
          ...
          <h2 className='font-medium text-2xl my-2 pt-4 text-white'>
          ...
          <div className='text-sm'>
            ...
            <ul className='list-disc my-2 pl-8'>
              ...
              <li>
                <strong>For External Processing</strong>: We provide personal
                information to our affiliates , other trusted businesses
                ,service providers or persons to process it for us, based on our
                instructions and in compliance with our Privacy Policy and any
                other appropriate confidentiality and security measures. We use
                service providers to improve our internal and external business
                processes, and offer additional support to customers and users.
              </li>
              <li>
          ...
          <h2 className='font-medium text-3xl text-white uppercase py-4 mt-6'>
          ...
          <h1 className='font-medium text-2xl my-2 text-white'>
            {"Children's"} Privacy
          </h1>
          <div className='text-sm'>
            <p className='my-3'>
          ...
          <h1 className='font-medium text-xl my-2 text-white'>Contact Us</h1>
          <div>
            ...
            <ul className='list-disc my-2 pl-8'>
              <li>By email:&nbsp;support@mybitstore.com</li>
              <li>By visiting this page on our website: mybitstore.com</li>
              {/* <li>By phone number: +233207633003</li> */}
            </ul>
